...
HD_PWD='C:/Users/ahmet/Desktop/4.sýnýf/Digital System Design/Sort_Memory_Separate/Sort_Memory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sort_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sort_memory.tcl
