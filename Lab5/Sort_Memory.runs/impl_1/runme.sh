...
HD_PWD='C:/Users/ahmet/Desktop/4.sýnýf/Digital System Design/Sort_Memory_Separate/Sort_Memory.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sort_memory.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sort_memory.tcl -notrace
